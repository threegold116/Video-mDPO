...
accelerate launch --config_file=/data/scir/sxjiang/project/Video-mDPO/scripts/multi_acl_gpu.yaml\
    /data/scir/sxjiang/project/Video-mDPO/llavaov/train_mdpo.py\
    /data/scir/sxjiang/project/Video-mDPO/llavaov/config_mdpo_loss_per_replace_frames.yaml