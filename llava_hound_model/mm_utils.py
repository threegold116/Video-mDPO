...
from llava_hound_model.constants import X_INDEX_TOKEN,X_TOKEN_INDEX
...
def tokenizer_image_token(prompt, tokenizer, image_token_index=X_TOKEN_INDEX["VIDEO"], return_tensors=None):
