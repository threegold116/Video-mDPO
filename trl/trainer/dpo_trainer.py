...
class DPOTrainer(Trainer):
    ...
    def _get_batch_logps(
        ...
        """
        if logits.shape[:-1] != labels.shape:#判断logits和labels的维度是否相同
    ...
    def get_batch_metrics(
        ...
        """Compute the DPO loss and other metrics for the given batch of inputs for train or test."""#计算DPO损失和其它指标
        metrics = {}
    ...
    def compute_loss(
        ...
        loss, metrics = self.get_batch_metrics(model, inputs, train_eval="train")#得到
